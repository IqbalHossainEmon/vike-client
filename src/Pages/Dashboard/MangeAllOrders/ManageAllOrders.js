...
const ManageAllOrders = () => {
  ...
  const handleApprove = () => {
    handleApproveClose();
    axios
      .put(`https://cryptic-mesa-14109.herokuapp.com/orders/${approveId}`)
      .then((result) => {
        if (result.data.matchedCount) {
          setReload(parseInt(reload) + 1);
        }
      });
  };
  ...
  React.useEffect(() => {
    axios
      .get(`https://cryptic-mesa-14109.herokuapp.com/orders`)
                ...
                >
                  ...
                  <TableCell align="right" sx={{ color: "info.main" }}>
                    ...
                    {order.state !== "Approved" && (
                      <Button
                        onClick={() => handleApproveOpen(order._id)}
                        className="mx-2"
                        variant="contained"
                      >
                        Approve
                  ...
                  <TableCell align="right">
                    <Button
                      onClick={() => handleDeleteOpen(order._id)}
                      variant="outlined"
                      color="error"
                    >
                      Delete
